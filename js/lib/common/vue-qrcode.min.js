...
function() {
    ...
    var t = function(t, e) {
        ...
        function() {
            function t(t, i) {
                var s;
                return "function" == typeof Object.create ? s = Object.create(t) : (n.prototype = t, s = new n, n.prototype = null),
                i && e(!0, s, i),
                s
            }
            function e(t, e, i) {
                for (var n, o, a = 0,
                f = (i = r.call(arguments, 2)).length; a < f; a++) {
                    o = i[a];
                    for (n in o) t && !s.call(o, n) || (e[n] = o[n])
                }
            }
            function i() {}
            var n = function() {},
            ...
            i.class_ = "Nevis",
            i.super_ = Object,
            i.extend = function(i, n, s, r) {
                var o = this;
                return "string" != typeof i && (r = s, s = n, n = i, i = null),
                "function" != typeof n && (r = s, s = n, n = function() {
            ...
            _ = o.extend(function(t) {
                ...
                for (this._badness = [], this._level = c.LEVELS[t.level], this._polynomial = [], this._value = t.value, this._version = 0, this._stringBuffer = []; this._version < 40 && (this._version++, n = 4 * (this._level - 1) + 16 * (this._version - 1), s = c.BLOCKS[n++], r = c.BLOCKS[n++], e = c.BLOCKS[n++], i = c.BLOCKS[n], n = e * (s + r) + r - 3 + (this._version <= 9), !(o <= n)););
                this._dataBlock = e,
                this._eccBlock = i,
                this._neccBlock1 = s,
                this._neccBlock2 = r;
                var a = this.width = 17 + 4 * this._version;
                this.buffer = _._createArray(a * a),
                this._ecc = _._createArray(e + (e + i) * (s + r) + r),
                this._mask = _._createArray((a * (a + 1) + 1) / 2),
                this._insertFinders(),
            ...
            },
            {
                _addAlignment: function(t, e) {
                    var i, n = this.buffer,
                    s = this.width;
                    for (n[t + s * e] = 1, i = -2; i < 2; i++) n[t + i + s * (e - 2)] = 1,
                    n[t - 2 + s * (e + i + 1)] = 1,
                    n[t + 2 + s * (e + i)] = 1,
                    n[t + i + 1 + s * (e + 2)] = 1;
                    for (i = 0; i < 2; i++) this._setMask(t - 1, e + i),
                ...
                _appendData: function(t, e, i, n) {
                    ...
                    for (r = 0; r < e; r++) {
                        if (255 !== (s = u.LOG[f[t + r] ^ f[i]])) for (o = 1; o < n; o++) f[i + o - 1] = f[i + o] ^ u.EXPONENT[_._modN(s + a[n - o])];
                        else for (o = i; o < i + n; o++) f[o] = f[o + 1];
                        f[i + n - 1] = 255 === s ? 0 : u.EXPONENT[_._modN(s + a[0])]
                    }
                },
                _appendEccToData: function() {
                    ...
                    s = this._eccBlock;
                    for (t = 0; t < this._neccBlock1; t++) this._appendData(e, i, n, s),
                    e += i,
                    n += s;
                    for (t = 0; t < this._neccBlock2; t++) this._appendData(e, i + 1, n, s),
                    e += i + 1,
                    n += s
                },
                _applyMask: function(t) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        for (s = 0; s < o; s++) for (e = 0, n = 0; n < o; n++, e++) 3 === e && (e = 0),
                        e || this._isMasked(n, s) || (r[n + s * o] ^= 1);
                        break;
                    case 3:
                        for (i = 0, s = 0; s < o; s++, i++) for (3 === i && (i = 0), e = i, n = 0; n < o; n++, e++) 3 === e && (e = 0),
                        e || this._isMasked(n, s) || (r[n + s * o] ^= 1);
                        break;
                    case 4:
                        for (s = 0; s < o; s++) for (e = 0, i = s >> 1 & 1, n = 0; n < o; n++, e++) 3 === e && (e = 0, i = !i),
                        i || this._isMasked(n, s) || (r[n + s * o] ^= 1);
                        break;
                    case 5:
                        for (i = 0, s = 0; s < o; s++, i++) for (3 === i && (i = 0), e = 0, n = 0; n < o; n++, e++) 3 === e && (e = 0),
                ...
                _checkBadness: function() {
                    ...
                    a = this.buffer,
                    f = this.width;
                    for (s = 0; s < f - 1; s++) for (n = 0; n < f - 1; n++)(a[n + f * s] && a[n + 1 + f * s] && a[n + f * (s + 1)] && a[n + 1 + f * (s + 1)] || !(a[n + f * s] || a[n + 1 + f * s] || a[n + f * (s + 1)] || a[n + 1 + f * (s + 1)])) && (r += _.N2);
                    var h = 0;
                    for (s = 0; s < f; s++) {
                        for (i = 0, o[0] = 0, t = 0, n = 0; n < f; n++) t === (e = a[n + f * s]) ? o[i]++:o[++i] = 1,
                        h += (t = e) ? 1 : -1;
                    ...
                    var c = 0,
                    u = h;
                    for (u += u << 2, u <<= 1; u > f * f;) u -= f * f,
                    c++;
                    for (r += c * _.N4, n = 0; n < f; n++) {
                        for (i = 0, o[0] = 0, t = 0, s = 0; s < f; s++) t === (e = a[n + f * s]) ? o[i]++:o[++i] = 1,
                        t = e;
                        r += this._getBadness(i)
                    }
                    return r
                ...
                _convertBitStream: function(t) {
                    ...
                    if (s > 9) {
                        ...
                        for (r[a + 1] = 0, r[a + 2] = 0; a--;) e = r[a],
                        r[a + 2] |= 255 & e << 4,
                        r[a + 1] = e >> 4;
                        r[1] |= 255 & t << 4,
                        r[0] = 64 | t >> 4
                    }
                    for (a = t + 3 - (s < 10); a < o;) r[a++] = 236,
                    r[a++] = 17
                },
                ...
                _finish: function() {
                    ...
                    n = c.FINAL_FORMAT[i + (this._level - 1 << 3)];
                    var s = this.buffer,
                    r = this.width;
                ...
                _interleaveBlocks: function() {
                    ...
                    for (t = 0; t < i; t++) {
                        for (e = 0; e < a; e++) n[r++] = h[t + e * i];
                        for (e = 0; e < f; e++) n[r++] = h[a * i + t + e * (i + 1)]
                    }
                    for (e = 0; e < f; e++) n[r++] = h[a * i + t + e * (i + 1)];
                    for (t = 0; t < s; t++) for (e = 0; e < a + f; e++) n[r++] = h[o + t + e * s];
                    this._stringBuffer = n
                },
                _insertAlignments: function() {
                    var t, e, i, n = this._version,
                    s = this.width;
                    if (n > 1) for (t = h.BLOCK[n], i = s - 7;;) {
                ...
                _insertFinders: function() {
                    ...
                    r = this.width;
                    for (t = 0; t < 3; t++) {
                        for (e = 0, n = 0, 1 === t && (e = r - 7), 2 === t && (n = r - 7), s[n + 3 + r * (e + 3)] = 1, i = 0; i < 6; i++) s[n + i + r * e] = 1,
                        s[n + r * (e + i + 1)] = 1,
                        s[n + 6 + r * (e + i)] = 1,
                        s[n + i + 1 + r * (e + 6)] = 1;
                        for (i = 1; i < 5; i++) this._setMask(n + i, e + 1),
                        this._setMask(n + 1, e + i + 1),
                        this._setMask(n + 5, e + i),
                        this._setMask(n + i + 1, e + 5);
                        for (i = 2; i < 4; i++) s[n + i + r * (e + 2)] = 1,
                        s[n + 2 + r * (e + i + 1)] = 1,
                        s[n + 4 + r * (e + i)] = 1,
                        s[n + i + 1 + r * (e + 4)] = 1
                    }
                ...
                _insertTimingGap: function() {
                    ...
                    for (e = 0; e < 7; e++) this._setMask(7, e),
                    this._setMask(i - 8, e),
                    this._setMask(7, e + i - 7);
                    for (t = 0; t < 8; t++) this._setMask(t, 7),
                ...
                _insertVersion: function() {
                    ...
                    r = this._version,
                    o = this.width;
                    if (r > 6) for (t = l.BLOCK[r - 7], e = 17, i = 0; i < 6; i++) for (n = 0; n < 3; n++, e--) 1 & (e > 11 ? r >> e - 12 : t >> e) ? (s[5 - i + o * (2 - n + o - 11)] = 1, s[2 - n + o - 11 + o * (5 - i)] = 1) : (this._setMask(5 - i, 2 - n + o - 11), this._setMask(2 - n + o - 11, 5 - i))
                },
                ...
                _pack: function() {
                    ...
                    for (e = 0; e < f; e++) for (t = this._stringBuffer[e], i = 0; i < 8; i++, t <<= 1) {
                ...
                _reverseMask: function() {
                    ...
                    for (t = 0; t < 8; t++) this._setMask(t + i - 8, 8),
                    this._setMask(8, t);
            ...
            },
            {
                ...
                getAll: function(t) {
                    ...
                    n = {};
                    for (e in i) g.hasOwn(i, e) && (n[e] = m._get(i[e], t));
                    return n
                },
                init: function(t, e, i) {
                    "function" != typeof i && (i = g.noop);
                    var n, s;
                    for (n in this.options) g.hasOwn(this.options, n) && (s = this.options[n], m._set(s, s.defaultValue, e), m._createAccessor(s, e, i));
                    this._setAll(t, e, !0)
                },
                set: function(t, e, i) {
            ...
            M = new k([new p("background", !0, "white"), new p("backgroundAlpha", !0, 1, g.abs), new p("element"), new p("foreground", !0, "black"), new p("foregroundAlpha", !0, 1, g.abs), new p("level", !0, "L", g.toUpperCase), new p("mime", !0, "image/png"), new p("padding", !0, null, g.abs), new p("size", !0, 100, g.abs), new p("value", !0, "")]),
            b = new w,
            B = o.extend(function(t) {
                ...
                this._canvasRenderer = new f(this, n, !0),
                this._imageRenderer = new v(this, s, s === e),
                this.update()
            },
            {
                get: function() {
