    ...
    fireDocumentEvent: function (type, data, bNoDetach) {
        ...
        if (typeof documentEventHandlers[type] !== 'undefined') {
            if (bNoDetach) {
                ...
                setTimeout(function () {
                    // Fire deviceready on listeners that were registered before cd.js was loaded.
                    if (type === 'deviceready') {
...
// Wrap in a setTimeout to support the use-case of having plugin JS appended to cd.js.
...
// Handler for the cd_plugins.js content.
...
exports.load = function (callback) {
    ...
    if (pathPrefix === null) {
        console.log('Could not find cd.js script tag. Plugin loading may fail.');
        pathPrefix = '';
    }
    injectIfNecessary('cordova/plugin_list', pathPrefix + 'cd_plugins.js', function () {
